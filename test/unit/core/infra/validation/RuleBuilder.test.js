...
describe('RuleBuilder', () => {
    ...
    describe('Validation Methods', () => {
        it('should validate isString', () => {
            ...
            rule.build();
            expect(rule.errors).to.be.empty;
        });

        it('should invalidate isString', () => {
            const rule = new RuleBuilder(validator, 123, 'Target').isString();
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target must be a string');
        });
        ...
        it('should invalidate isNumber', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target must be a number');
        });
        ...
        it('should invalidate isArray', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target must be an array');
        });
        ...
        it('should invalidate isBoolean', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target must be a boolean');
        });
    });
    ...
    describe('Presence Validation', () => {
        ...
        it('should invalidate isRequired', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target is required');
        });
    ...
    describe('Equality and Inequality Validation', () => {
        ...
        it('should invalidate isEqual', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be equal to 20');
        });
        ...
        it('should invalidate isNotEqual', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must not be equal to 10');
        });
    });
    ...
    describe('Numeric Validation', () => {
        ...
        it('should invalidate isBetween', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be between 10 and 20');
        });
        ...
        it('should invalidate isGreaterThan', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be greater than 10');
        });
        ...
        it('should invalidate isGreaterThanOrEqual', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be greater than or equal to 10');
        });
        ...
        it('should invalidate isLessThan', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be less than 10');
        });
        ...
        it('should invalidate isLessThanOrEqual', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be less than or equal to 10');
        });
    });
    ...
    describe('Enum Validation', () => {
        ...
        it('should invalidate isInEnum', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Target value must be one of (apple, banana, orange)');
        });
    });
    ...
    describe('Custom Validation', () => {
        ...
        it('should invalidate isMust', () => {
            ...
            rule.build();
            expect(rule.errors).to.have.lengthOf(1);
            expect(rule.errors[0].error).to.equal('Value must be greater than 10');
        });
    });
});
