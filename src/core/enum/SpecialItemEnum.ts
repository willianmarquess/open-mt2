export enum SpecialItemEnum {
    ...
    SKILL_BOOK_SHUN_ZI = 50301,
    SKILL_BOOK_WU_ZI = 50302,
    SKILL_BOOK_WEILIAO_ZI = 50303,
    SKILL_BOOK_COMBO_MASTERY = 50304,
    SKILL_BOOK_COMBO_MASTER = 50305,
    SKILL_BOOK_COMBO_ART = 50306,
    SKILL_BOOK_SHINSOO_LANGUAGE = 50311,
    SKILL_BOOK_CHUNJO_LANGUAGE = 50312,
    SKILL_BOOK_JINNO_LANGUAGE = 50313,
    SKILL_BOOK_POLYMORPH = 50314,
    SKILL_BOOK_POLYMORPH_ADVANCED = 50315,
    SKILL_BOOK_POLYMORPH_MASTER = 50316,
    SKILL_BOOK_MINING = 50600,
