...
export class BerserkSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.BERSERK;
    ...
    public readonly affects: Set<SkillAffectEnum> = new Set([SkillAffectEnum.JEONGWIHON]);
    public readonly applies: Set<SkillApplies> = new Set([
        {
            kind: SkillApplyKindEnum.POINT,
            pointOn: PointsEnum.ATTACK_SPEED,
            calculateDuration: (context: SkillCalcContext): number => 60 + 90 * context.skillLevel,
            calculateAmount: (context: SkillCalcContext): number => 50 * context.skillLevel,
        },
        {
            kind: SkillApplyKindEnum.POINT,
            pointOn: PointsEnum.MOVE_SPEED,
            calculateDuration: (context: SkillCalcContext): number => 60 + 90 * context.skillLevel,
            calculateAmount: (context: SkillCalcContext): number => 20 * context.skillLevel,
        },
    ]);
