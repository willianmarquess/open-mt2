...
export class BashSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.BASH;
    ...
    public readonly applies: Set<SkillApplies> = new Set([
        {
            ...
            calculateAmount: (context: SkillCalcContext): number =>
                -(2.3 * context.attack + (3 * context.attack + context.str * 4 + context.con * 3) * context.skillLevel),
    ...
    calculateManaCost(context: SkillCalcContext): number {
        return 60 + 150 * context.skillLevel;
    }
