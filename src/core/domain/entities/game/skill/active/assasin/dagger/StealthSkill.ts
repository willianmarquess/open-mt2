...
export class StealthSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.STEALTH;
    ...
    public readonly applies: Set<SkillApplies> = new Set([
        {
            ...
            calculateDuration: (context: SkillCalcContext) => 15 + 30 * context.skillLevel,
        },
    ]);
    ...
    calculateManaCost(context: SkillCalcContext): number {
        return 30 + 60 * context.skillLevel;
    }
