...
export class FeatherWalkSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.FEATHER_WALK;
    ...
    public readonly applies: Set<SkillApplies> = new Set([
        {
            ...
            calculateAmount: (context: SkillCalcContext): number => 60 * context.skillLevel,
    ...
    calculateManaCost(context: SkillCalcContext): number {
        return 30 + 40 * context.skillLevel;
    }
