...
export class BlessingSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.BLESSING;
    ...
    public readonly affects: Set<SkillAffectEnum> = new Set([SkillAffectEnum.BLESSING]);
    public readonly applies: Set<SkillApplies> = new Set([
        {
            kind: SkillApplyKindEnum.POINT,
            pointOn: PointsEnum.RESIST_NORMAL_DAMAGE,
