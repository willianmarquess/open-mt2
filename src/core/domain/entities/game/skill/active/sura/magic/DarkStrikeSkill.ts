...
export class DarkStrikeSkill extends ActiveSkill {
    public readonly id: number = SkillEnum.DARK_STRIKE;
    ...
    public readonly applies: Set<SkillApplies> = new Set([
        {
            ...
            calculateAmount: (context: SkillCalcContext): number =>
                -(
                    ...
                    2 * context.int +
                    (13 * context.int + 6 * context.magicWeaponAttack + MathUtil.getRandomInt(50, 100)) *
