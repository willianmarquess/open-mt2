...
'{{SEED_ADMIN_PASSWORD_HASH}}', 1, 'admin');

INSERT INTO auth.account (`deleteCode`, `email`, `lastLogin`, `password`,
`accountStatusId`, `username`)
VALUES ('1234567', 'admin1@test.com', NULL,
'{{SEED_ADMIN_PASSWORD_HASH}}', 1, 'admin1');
...
CREATE TABLE game.player (
    ...
    availableSkillPoints INT UNSIGNED NOT NULL DEFAULT 0,
    slot TINYINT UNSIGNED NOT NULL DEFAULT 0,
    horseLevel TINYINT UNSIGNED NOT NULL DEFAULT 0,
    horseHealth INT UNSIGNED NOT NULL DEFAULT 0,
